...
export const AdminShell = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[#050505] font-mono">
      <aside className="w-64 flex flex-col z-20 border-r border-[#1f1f1f]">
        <div className="p-6 border-b border-[#1f1f1f]">
          <div className="flex items-center gap-3">
            ...
            <span className="text-lg tracking-[0.1em] font-bold uppercase">METALAB</span>
          </div>
        </div>

        <nav className="flex-1 overflow-y-auto px-4 py-8 custom-scrollbar">
          <div className="text-[10px] text-gray-600 uppercase tracking-widest mb-4 px-2">Navigation</div>
        ...
        <div className="p-4 border-t border-[#1f1f1f] space-y-2">
          <Link to="/app/identity" className="flex items-center gap-3 px-3 py-2 text-gray-600 hover:text-white">
            <User size={14} /> <span className="text-[11px] uppercase">Identity</span>
          </Link>
          <Link to="/app/settings" className="flex items-center gap-3 px-3 py-2 text-gray-600 hover:text-white">
            <Settings size={14} /> <span className="text-[11px] uppercase">Settings</span>
          </Link>
          <button onClick={handleLogout} className="w-full flex items-center gap-3 px-3 py-2 text-gray-600 hover:text-red-500 transition-colors">
            <LogOut size={14} /> <span className="text-[11px] uppercase">Sign Out</span>
          </button>
        </div>
      </aside>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="h-16 px-8 flex items-center justify-between z-10 shrink-0 border-b border-[#1f1f1f]">
          <div className="flex items-center gap-4 text-[11px] font-bold text-accent uppercase">
